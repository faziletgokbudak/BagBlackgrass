...
class IClassifier(nn.Module):
    def __init__(self, feature_extractor, feature_size, output_class, input_c=5):
        super(IClassifier, self).__init__()
        self.input_c = input_c
        self.adopt = nn.Sequential(nn.Conv2d(self.input_c, 3, 3, 1, padding=1, bias=False), nn.BatchNorm2d(3),
                                   nn.ReLU())
